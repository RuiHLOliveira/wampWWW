...
cadastrado para receber o formulário*/
       ...
       $email_to = 'ruigx@hotmail.com'; //não esqueça de substituir este email pelo seu.
      
    $status = true; //mail($email_to, $subject, $corpo, $headers); //enviando o email.
	...
	echo "<script> window.location.href = 'contato.htm'; </script>"; //mudar o site para redirecionar após o envio do form.
?>